...
class cxTextValidator {
   public:
       ...
       */
      explicit cxTextValidator(const string& pTextStr = "",
       ...
       */
      virtual void setTextStr(const string& pTextStr);

      /**
       * Returns the text string
       * @return The text string
       */
      virtual const string& getTextStr() const;

      /**
       * Sets the validator string
       * @param pValidatorStr Validator string--see README.txt for details of validator strings
       */
      virtual void setValidatorStr(const string& pValidatorStr);

      /**
       * Returns the validator string
       * @return Validator string
       */
      virtual const string& getValidatorStr() const;
       ...
       * @return True or false, depending on whether string passes validation
       */
      virtual bool textIsValid(const string& pTextStr) const;
       ...
       */
      virtual string addImpliedChars() const;
       ...
       */
      virtual void addImpliedChars(string& pTextStr) const;
   ...
   private:
      string mTextStr;      // The string to be validated
      string mValidatorStr; // String to use for input validation
